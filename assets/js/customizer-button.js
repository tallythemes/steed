jQuery(document).ready(function() {
	...
	jQuery('#customize-info').append('<a style="width: 94%; display: inline-block; text-align: center; margin: 1% 3% 2% 3%;" href="'+steed_objectL10n.btn_2_url+'" class="button" target="_blank">{btn_2_text}</a>'.replace('{btn_2_text}',steed_objectL10n.btn_2_text));
