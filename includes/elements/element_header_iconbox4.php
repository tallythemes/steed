<?php
class steed_element_header_iconbox4{
	...
	function __construct(){
		$this->customize_prefix = 'header_iconbox4_';
		$this->customize_section = 'steed_header_iconbox4';
	...
	function html(){
		if( steed_theme_mod($this->customize_prefix.'active') == true){
			echo '<div class="header_iconbox header_iconbox_4">';
	...
	public function css($css){
		...
		if(steed_theme_mod($this->customize_prefix.'text_color') != ''){
			$new_css .='.header_iconbox_4 a, .header_iconbox_4 strong{';
		 ...
		 if(steed_theme_mod($this->customize_prefix.'bg_color') != ''){
			...
			$new_css .='.header_iconbox_4:hover a, .header_iconbox_4:hover strong{';
		 ...
		 if(steed_theme_mod($this->customize_prefix.'des_hover_color') != ''){
			$new_css .='.header_iconbox_4:hover span{';
		 ...
		 if(steed_theme_mod($this->customize_prefix.'icon_hover_color') != ''){
			$new_css .='.header_iconbox_4:hover i.fa{';
...
$GLOBALS['steed_element_header_iconbox4'] = new steed_element_header_iconbox4;
function steed_element_header_iconbox4(){
	$GLOBALS['steed_element_header_iconbox4']->html();
}