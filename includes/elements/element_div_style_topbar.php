<?php
class steed_element_div_style_topbar{
	...
	function __construct(){
		$this->customize_prefix = 'topbar_style_';
		$this->customize_section = 'steed_topbar';
		$this->style_class = '.topbar';
		
		add_filter('steed_custom_css', array($this, 'css'));
		add_action( 'customize_register', array($this, 'customize') );
		
		add_filter('steed_topbar_color_mood', array($this, 'color_mood'));
	}	
...
new steed_element_div_style_topbar;