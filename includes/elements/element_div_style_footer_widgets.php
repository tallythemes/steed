<?php
class steed_element_div_style_footer_widgets{
	...
	function __construct(){
		$this->customize_prefix = 'footer_widgets_style_';
		...
		add_filter('steed_footer_widgets_color_mood', array($this, 'color_mood'));
	}	
...
new steed_element_div_style_footer_widgets;