...
class steed_Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'steed-alpha-color-picker',
			get_template_directory_uri() . '/includes/vendors/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'steed-alpha-color-picker',
			get_template_directory_uri() . '/includes/vendors/alpha-color-picker/alpha-color-picker.css',
