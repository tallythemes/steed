<?php
/**
 * Orginal Code from Hestia WordPress theme - https://wordpress.org/themes/hestia/ (Under GPL)
 *
 * Steed - About page class
 *
 ...
 *                'recommended_plugins' => __( 'Recommended Plugins', 'steed' ),
 *                'child_themes'     => __( 'Child themes', 'steed' ),
 ...
 *                      'text' => esc_html__( 'We offer excellent support through our advanced ticketing system. Make sure to register your purchase before contacting support!','steed' ),
 *                      'button_label' => esc_html__( 'Contact Support','steed' ),
 *                      'button_link' => esc_url( 'https://steed.com/contact/' ),
 *                      'is_button' => true,
 *                      'is_new_tab' => false
 *                  ),
 *            ),
 ...
 *               'first_step' => array (
 *                  'title' => esc_html__( 'Step 1 - Implement recommended actions','steed' ),
 ...
 *                  'button_label' => esc_html__( 'Check recommended actions','steed' ),
 ...
 *                'pro_theme_link'      => 'https://steed.com/themes/flymag-pro/',
 *                'get_pro_theme_label' => sprintf( __( 'Get %s now!', 'steed' ), 'FlyMag Pro' ),
 *                'features'            => array(
 *                    array(
 ...
 *                    ),
 *                    array(
 *                        'title'       => __( 'Unlimited color option', 'steed' ),
 *                        'description' => __( 'You can change the colors of each section. You have unlimited options.', 'steed' ),
 *                        'is_in_lite'  => 'true',
 *                        'is_in_pro'   => 'true',
 *                    ),
 *                    array(
 ...
 *                    ),
 *                    array(
 *                        'title'       => __( 'Featured Area', 'steed' ),
 *                        'description' => __( 'Have access to a new featured area.', 'steed' ),
 *                        'is_in_lite'  => 'false',
 *                        'is_in_pro'   => 'true',
 *                    ),
 *                    array(
 *                        'title'       => __( 'Footer credits', 'steed' ),
 *                        'description' => '',
 *                        'is_in_lite'  => 'false',
 *                        'is_in_pro'   => 'true',
 *                    ),
 *                    array(
 *                        'title'       => __( 'Extra widgets areas', 'steed' ),
 *                        'description' => __( 'More widgets areas for your theme.', 'steed' ),
 *                        'is_in_lite'  => 'false',
 *                        'is_in_pro'   => 'true',
 *                    ),
 *                    array(
 *                        'title'       => __( 'Support', 'steed' ),
 *                        'description' => __( 'You will benefit of our full support for any issues you have with the theme.', 'steed' ),
 *                        'is_in_lite'  => 'false',
 *                        'is_in_pro'   => 'true',
 *                    ),
 *                ),
 ...
 *                'install_label' => esc_html__( 'Install', 'steed' ),
 ...
 *                    ),
 *                    array(
 *                        'link'        => 'http://steed.com/plugins/easy-content-types/',
 *                    ),
 *                    array(
 ...
 *                'content'            => array(
 *                    'pirate-forms' => array(
 *                        'title'       => __( 'Pirate Forms', 'steed' ),
 *                        'description' => __( 'Makes your contact page more engaging by creating a good-looking contact form on your website. The interaction with your visitors was never easier.', 'steed' ),
 *                        'link_label'  => __( 'Install Pirate Forms', 'steed' ),
 ...
 *            ),
 *        );
 *        steed_About_Page::init( $config );
 *
 * @package steed
 * @subpackage Admin
 * @since 1.0.0
 */
if ( ! class_exists( 'steed_About_Page' ) ) {
	/**
	 * Singleton class used for generating the about page of the theme.
	 */
	class steed_About_Page {
		/**
		 * Define the version of the class.
		 *
		 * @var string $version The steed_About_Page class version.
		 */
		...
		/**
		 * The single instance of steed_About_Page
		 *
		 * @var steed_About_Page $instance The  steed_About_Page instance.
		 */
		private static $instance;

		/**
		 * The Main steed_About_Page instance.
		 *
		 * We make sure that only one instance of Steed_About_Page exists in the memory at one time.
		 *
		 * @param array $config The configuration array.
		 */
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof steed_About_Page ) ) {
				self::$instance = new steed_About_Page;
		...
		public function activation_admin_notice() {
			...
			if ( is_admin() && ( 'themes.php' == $pagenow ) && isset( $_GET['activated'] ) ) {
				add_action( 'admin_notices', array( $this, 'steed_about_page_welcome_admin_notice' ), 99 );
			}
		}
		 ...
		 */
		public function steed_about_page_welcome_admin_notice() {
		 ...
		 */
		public function steed_about_page_render() {
			...
			if ( ! empty( $welcome_title ) || ! empty( $welcome_content ) || ! empty( $this->tabs ) ) {
				...
				echo '<a href="'.esc_url('http://tallythemes.com/').'" target="_blank" class="wp-badge epsilon-welcome-logo"></a>';
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/includes/vendors/ti-about-page/images/placeholder_plugin.png';
			}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ti-about-page-css', get_template_directory_uri() . '/includes/vendors/ti-about-page/css/ti_about_page_css.css', array(), STEED_VERSION );

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/includes/vendors/ti-about-page/js/ti_about_page_scripts.js', array( 'jquery' ), STEED_VERSION );
				...
				wp_localize_script(
					'ti-about-page-js', 'tiAboutPageObject', array(
						...
						'activating_string'        => esc_html__( 'Activating', 'steed' ),
					)
				);
